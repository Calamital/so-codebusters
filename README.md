...
The algorithms I created to encode the ciphers were made from the steps found in the [codebusters overview](https://toebes.com/codebusters/Samples/CodeBusters_Overview.pdf).
